...
namespace PA_MDM_MvcApp_2021.Areas.ManagementPanel.Controllers
{
    ...
    public class ContactsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ContactId,ContactAdress,ContactNumber,TwitterURL,InstagramURL,FacebookURL,YoutubeURL,LinkedinURL,IsActive")] Contacts contacts)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ContactId,ContactAdress,ContactNumber,TwitterURL,InstagramURL,FacebookURL,YoutubeURL,LinkedinURL,IsActive")] Contacts contacts)
        {
            if (ModelState.IsValid)
            {
